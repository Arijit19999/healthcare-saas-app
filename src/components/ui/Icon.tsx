...
const base = (path: React.ReactNode) =>
  React.forwardRef<SVGSVGElement, IconProps>(({ size = 20, ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
      height={size}
...
export const EyeOffIcon = base(
  <>
    <path d="M17.94 17.94A10.94 10.94 0 0112 19c-7 0-10-7-10-7a17.66 17.66 0 014.06-4.94" />
    <path d="M9.9 4.24A10.94 10.94 0 0112 4c7 0 10 7 10 7a17.66 17.66 0 01-3.17 4.31" />
...
export const TrendDownIcon = base(
  <>
...
export const SpinnerIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
